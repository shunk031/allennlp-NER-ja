...
local tng_data_path = "datasets/kwdlc/kwdlc_ner_tng.txt";
local val_data_path = "datasets/kwdlc/kwdlc_ner_val.txt";
local tst_data_path = "datasets/kwdlc/kwdlc_ner_tst.txt";
